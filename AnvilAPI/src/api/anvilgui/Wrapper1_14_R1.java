...
public class Wrapper1_14_R1 implements VersionWrapper {
    ...
    public void sendPacketOpenWindow(Player player, int containerId) {
        toNMS(player).playerConnection.sendPacket(new PacketPlayOutOpenWindow(containerId, Containers.ANVIL, new ChatMessage("Input Name:")));
    }
    ...
    private class AnvilContainer extends ContainerAnvil {
        ...
        public AnvilContainer(Player player) {
            ...
            setTitle(new ChatMessage("Input Name:"));
        }
