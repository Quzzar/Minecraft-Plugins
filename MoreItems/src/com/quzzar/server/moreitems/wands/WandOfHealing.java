...
import com.quzzar.server.moreitems.spells.Healing;

public class WandOfHealing implements Wand {

	@Override
	public ItemStack getWand() {
		return ItemManager.getItemClone(ItemType.WAND_OF_HEALING);
	}

	public void rightClick(Player player, ItemStack wand) {
		Healing.castSpell(player);

		if (ItemUtils.percentChance(1)) {
