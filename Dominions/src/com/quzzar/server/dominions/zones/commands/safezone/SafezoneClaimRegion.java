...
public class SafezoneClaimRegion {
	public static String commandLayout = "/safezonezone claimregion x1 z1 x2 z2";
	...
	public static void run(Player player, String[] args) {
		...
		player.sendMessage(ChatColor.GREEN + "Claimed "+count+" chunks as SafeZone.");
